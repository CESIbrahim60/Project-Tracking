...
$sql = "SELECT c.*, u.full_name FROM clients c 
        LEFT JOIN users u ON c.user_id = u.id 
        WHERE c.status = 'active' ORDER BY c.created_at DESC LIMIT 10";
...
<div class="page-header">
    <h1 class="page-title"><?php echo t('sales_dashboard'); ?></h1>
...
<div class="dashboard-grid">
    <div class="stat-card">
        <div class="stat-card-label"><?php echo t('total_leads'); ?></div>
        <div class="stat-card-value"><?php echo $total_leads; ?></div>
    </div>
    <div class="stat-card">
        <div class="stat-card-label"><?php echo t('new_leads'); ?></div>
        <div class="stat-card-value"><?php echo $new_leads; ?></div>
    </div>
    <div class="stat-card">
        <div class="stat-card-label"><?php echo t('qualified'); ?></div>
        <div class="stat-card-value"><?php echo $qualified_leads; ?></div>
    </div>
    <div class="stat-card">
        <div class="stat-card-label"><?php echo t('won'); ?></div>
        <div class="stat-card-value"><?php echo $won_leads; ?></div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="dashboard-grid">
            ...
            <a href="/maysan/pages/sales/leads.php" class="btn btn-secondary">
                📋 <?php echo t('manage_leads'); ?>
            </a>
            <a href="/maysan/pages/sales/clients.php" class="btn btn-info">
                👥 <?php echo t('manage_clients'); ?>
            </a>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        <h2 class="card-title"><?php echo t('recent_leads'); ?></h2>
        <a href="/maysan/pages/sales/leads.php" class="btn btn-outline btn-sm"><?php echo t('view_all'); ?></a>
    </div>
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                <?php 
                $display_leads = array_slice($leads, 0, 5);
                foreach ($display_leads as $lead): 
                ?>
                <tr>
